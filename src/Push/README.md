...
$messages = new \Plinthify\Localytics\Push\Message\LocalyticsMessages();
...
$push = new \Plinthify\Localytics\Push\LocalyticsPushNotification($account, $messages, $target_obj->getType(), $app_id, $request_id, $campaign_key);
